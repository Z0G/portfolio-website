export const Home = () => {
    ...
    >
        <div className="text-center z-10 px-4">
            ...
            I’m a QA engineer with 2+ years of experience in software testing and tech support, 
            passionate about building reliable systems and user-focused solutions. Currently pursuing my 
            MEng in Quality Systems Engineering at Concordia University.
            </p>
